...
struct ShippingModel: Codable {
    ...
    var posts      : ShippingPost?   = ShippingPost()
    ...
    init(from decoder: Decoder) throws {
        ...
        posts      = try values.decodeIfPresent(ShippingPost.self   , forKey: .posts      )
    }
...
struct ShippingPost: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        data         = try values.decodeIfPresent([ShippingData].self  , forKey: .data         )
