...
class GoogleAnalytics: UIViewController {

    @IBOutlet weak var analyticsViewIdField: UITextField!
    @IBOutlet weak var gaMeasurementIDField: UITextField!
    @IBOutlet weak var buttonSave: UIButton!
    @IBOutlet weak var buttonChooseFile: UIButton!
    ...
    override func viewDidLoad() {
        ...
        self.buttonChooseFile.layer.cornerRadius = 3
        let textAttributes = [NSAttributedString.Key.foregroundColor:UIColor.white]
        navigationController?.navigationBar.titleTextAttributes = textAttributes
        
//        self.analyticsViewIdField.addBottomBorder()
//        self.gaMeasurementIDField.addBottomBorder()
    ...
    @IBAction func actionSave(_ sender: Any) {
        if analyticsViewIdField.text != "" && gaMeasurementIDField.text != "" && self.statusFieldValue.text != "" {
            self.vm.postGoogleAnalytics(param: analyticsViewIdField.text ?? "")
        } else {
...
extension GoogleAnalytics: UITableViewDelegate, UITableViewDataSource {
