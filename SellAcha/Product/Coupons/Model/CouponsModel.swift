...
struct CouponsModel: Codable {
    ...
    var posts      : CouponsPost?   = CouponsPost()
    ...
    init(from decoder: Decoder) throws {
        ...
        posts      = try values.decodeIfPresent(CouponsPost.self   , forKey: .posts      )
    }
...
struct CouponsPost: Codable {
    
    var currentPage  : Int?     = nil
    var data         : [CouponsData]?  = []
    ...
    init(from decoder: Decoder) throws {
        ...
        data         = try values.decodeIfPresent([CouponsData].self  , forKey: .data         )
